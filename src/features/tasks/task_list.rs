use iced::widget::{
    Text, button, checkbox, column, container, hover, right_center, row, space, text,
};
            ...
            let task_menu = menu(
                ...
                vec![
                            ...
                            PRIORITY_OPS
                                ...
                                .map(|p| {
                                    ...
                                    menu_item(p)
                                        ...
                                        .icon_right(move || select_icon(is_selected))
                    ...
                    menu_item("Status")
                        ...
                        .with_menu(vec![
                            menu_item("Open")
                                .icon_left(move || select_icon(!is_done))
                                .on_press(Message::ChangeStatus(i, false)),
                            menu_item("Done")
                                .icon_left(move || select_icon(is_done))
...
fn selected_count(items: &Vec<Task>) -> i32 {
    items
        .iter()
        .fold(0, |acc, t| if t.is_checked { acc + 1 } else { acc })
}
